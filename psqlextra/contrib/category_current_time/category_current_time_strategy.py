...
class PostgresCategoryCurrentTimePartitioningStrategy(
    PostgresPartitioningStrategy
):
    """Implments a category and time based partitioning strategy where on the first level a partition is created for each category and on the second level each partition
